...
// redireciona o usuario para a home ao clicar no logo 

document.getElementById("logo").addEventListener("click", () => { window.location.href = "index.html" })


// realiza o direcionamento ao clicar em determinado elemento no menu
...
// realiza as funções relacionadas com o menu 
function menu() {
...
// oculta ou torna um elemento visivel
...
function destin(actualDestin) {
    ...
    switch (actualDestin) {
        ...
        case 1:
            document.querySelectorAll(".Moon").forEach(a => a.style.display = "grid");
        ...
        case 2:
            ...
            document.querySelectorAll(".Mars").forEach(a => a.style.display = "grid");
            document.querySelectorAll(".Europa").forEach(a => a.style.display = "none");
            document.querySelectorAll(".Titan").forEach(a => a.style.display = "none");
        ...
        case 3:
            document.querySelectorAll(".Moon").forEach(a => a.style.display = "none");
            document.querySelectorAll(".Mars").forEach(a => a.style.display = "none");
            document.querySelectorAll(".Europa").forEach(a => a.style.display = "grid");
            document.querySelectorAll(".Titan").forEach(a => a.style.display = "none");
        ...
        case 4:
            ...
            document.querySelectorAll(".Mars").forEach(a => a.style.display = "none");
            document.querySelectorAll(".Europa").forEach(a => a.style.display = "none");
            document.querySelectorAll(".Titan").forEach(a => a.style.display = "grid");
